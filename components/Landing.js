...
const Landing = () => {
  ...
  return (
    <div className='flex justify-evenly h-full w-full position:relative bg-[#EDE6D4]'>
      ...
      <button onClick = {() => router.push('/vaults')} className='border-4 border-black rounded-lg p-4 bg-[#EDE6D4] font-bold absolute top-80 text-4xl mt-40 hover:shadow-xl hover:text-[#EDE6D4] hover:bg-black hover:border-[#EDE6D4]'> Enter App</button>
